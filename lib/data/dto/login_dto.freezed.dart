...
class _$_LoginDTO implements _LoginDTO {
  _$_LoginDTO({required this.user, required this.jwt});
  ...
  @override
  String toString() {
    return 'LoginDTO(user: $user, jwt: $jwt)';
  }
...
abstract class _LoginDTO implements LoginDTO {
  factory _LoginDTO({required final User user, required final JWT jwt}) =
      _$_LoginDTO;
